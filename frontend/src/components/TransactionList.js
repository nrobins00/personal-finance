...
function TransactionList({transactions}) {
    ...
    return (
        <>
            <div>
                <button onClick={() => {toggleCategory("Travel")}} >
                    Travel: {filteredCats.has("Travel") ? "filtered" : "showing"}</button>
                <button onClick={() => {toggleCategory("Food and Drink")}} >
                    Food and Drink: {filteredCats.has("Food and Drink") ? "filtered" : "showing"}</button>
                <button onClick={() => {toggleCategory("Payment")}} >
                    Payment: {filteredCats.has("Payment") ? "filtered" : "showing"}</button>
            </div>
